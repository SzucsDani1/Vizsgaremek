...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Ápr 13. 21:51
...
DROP TABLE IF EXISTS `bevasarlolista`;
...
--
DROP TRIGGER IF EXISTS `bevasarloLista_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `bevasarloLista_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `bevasarloLista_Update`;
DELIMITER $$
...
--
DROP TRIGGER IF EXISTS `ertekeles_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `ertekeles_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `ertekeles_Update`;
DELIMITER $$
...
DROP TABLE IF EXISTS `etelfajta`;
...
--
DROP TRIGGER IF EXISTS `etelfajta_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `etelfajta_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `etelfajta_Update`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `ujadat_etelfajta`;
DELIMITER $$
...
--
DROP TRIGGER IF EXISTS `etrend_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `etrend_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `etrend_Update`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `ujadat_etrend`;
DELIMITER $$
...
DROP TABLE IF EXISTS `felhasznalojog`;
...
--
DROP TRIGGER IF EXISTS `felhasznalojog_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `felhasznalojog_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `felhasznalojog_Update`;
DELIMITER $$
...
--
DROP TRIGGER IF EXISTS `felhasznalok_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `felhasznalok_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `felhasznalok_Update`;
DELIMITER $$
...
DROP TABLE IF EXISTS `gyerekmenu`;
...
--
DROP TRIGGER IF EXISTS `gyerekmenu_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `gyerekmenu_Insert`;
DELIMITER $$
...
--
DROP TRIGGER IF EXISTS `hetimenu_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `hetimenu_Insert`;
DELIMITER $$
...
--
DROP TRIGGER IF EXISTS `hozzaszolasok_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `hozzaszolasok_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `hozzaszolasok_Update`;
DELIMITER $$
...
--
DROP TRIGGER IF EXISTS `hozzavalok_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `hozzavalok_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `hozzavalok_Update`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `ujadat_hozzavalo`;
DELIMITER $$
...
DROP TABLE IF EXISTS `kedvenceklista`;
...
--
DROP TRIGGER IF EXISTS `kedvenceklista_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `kedvenceklista_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `kedvenceklista_Update`;
DELIMITER $$
...
--
DROP TRIGGER IF EXISTS `konyha_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `konyha_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `konyha_Update	`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `ujadat_konyha`;
DELIMITER $$
...
DROP TABLE IF EXISTS `receptetrend`;
...
--
DROP TRIGGER IF EXISTS `receptEtrend_Delete`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `receptEtrend_Insert`;
DELIMITER $$
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `receptEtrend_Update	`;
DELIMITER $$
...
-- Események
--
DROP EVENT IF EXISTS `hetimenu_general`$$
...
DROP EVENT IF EXISTS `gyerekmenu_general`$$
